    ...
    if (content != '') {
        $.ajax({
            ...
            success: function (data) {
                if (data.success) {
                    location.href="${base}/m/goods/goodsConsultList?goodsId="+goodsId+"&url="+url+"&refereurl="+refereurl+"&orderState="+orderState;
                } else {
...
<body>
<div class="phone_hd">
	<a class="back" href="${base}/m/goods/goodsConsultList?goodsId=${goodsId}&url=${url}&refereurl=${refereurl}&orderState=${orderState}">
...
<div class="order_page">
		<table class="trade_table" cellpadding="0" cellspacing="0">
	    	<tbody>
	        	<tr>
	            	<td class="td_left"><img src="/qdmall-front/res/html5/images/order_info_01.png" width="30" height="30" /></td>
	                <td>
	                	<ul>
