		            ...
		            <#if cartVo.list??>
		            	<#list cartVo.list as cart>
				            <tr id="cart_item_${cart.goodsId}">
								...
								<td class="w70"><div class="cart-goods-pic"><a href="${base}/product/detail?id=${cart.goodsId}" target="_blank"><span class="thumb size60"><i></i><img src="${imgServer}${cart.goodsImages}" style="width: 60px;height: 60px;" /></span></a></div></td>
				              	<td class="tl vt">
