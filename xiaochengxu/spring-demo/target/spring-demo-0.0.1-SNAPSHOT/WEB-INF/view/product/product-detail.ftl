...
<@p.header title="${goods.goodsName}－采购家园" keywords="${goods.goodsKeywords}" description="${goods.goodsDescription}"/>
	...
	<div class="nch-breadcrumb-layout">
	  <div class="nch-breadcrumb wrapper">
	  	<i class="icon-home"> </i>
			...
			<span class="arrow"><a href="${goods.realurl}">${goods.goodsName}</a></span>
		</div>
	</div>  
	<!-- 导航条 end-->  
...
<script>
	...
	$(document).ready(function() {
		...
		$(".nc-key").load("${base}/product/goodsinfo?goodsId=" + goodsId);
	});
</script>
