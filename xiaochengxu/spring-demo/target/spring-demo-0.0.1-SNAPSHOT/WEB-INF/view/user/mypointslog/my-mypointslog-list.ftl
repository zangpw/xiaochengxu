<script type="text/javascript" src="${base}/res/js/member/member.js"></script><<table class="ncu-table-style">
	<thead>
		<tr>
...
</table>script type="text/javascript" src="${base}/res/js/member/member.js"></script>
