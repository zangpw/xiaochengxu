  					...
  					<div class="layout-l">
   						<div class="member-intro">
      						<dl>
                               ...
                               <dd class="predeposit">
                        				<input type="button" value="积分提现" onclick="tip()"/>
      							</dd>
              				</dl>
      						<ul>
							   ...
							   <form  id ="cash" action="${base}/withdraw/save" method="get" style="display:none;width=100%;align-center=center">
									<div class="login" > 
									    <div class="login-item"> 
									        <label>提现积分：</label> 
									        <div><input type="text" name="memberRankPoints" /></div> 
									    </div> 
									    <div class="login-item"> 
									        <label>提现人：</label> 
									        <div><input type="text" name="withdrawName"/></div> 
									    </div> 
									     <div class="login-item"> 
									        <label>电话号码：</label> 
									        <div><input type="text" name="withdrawPhone"/></div> 
									    </div> 
