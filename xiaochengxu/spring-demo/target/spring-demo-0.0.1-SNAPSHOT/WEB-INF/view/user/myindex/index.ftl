...
<div class="public-top-layout w">
    <div class="topbar wrapper">
        ...
        <@shiro.user>
            您好<span>&nbsp;<a href="${base}/user/index/"><@shiro.principal/></a></span>，欢迎来到<a href="${base}"  title="首页" alt="首页">qdmall商城系统演示站</a>
            <span>[<a href="${base}/logout">退出</a>]</span>
        </@shiro.user>
        <@shiro.guest>
            您好，欢迎来到<a href="${base}" title="首页" alt="首页">qdmall商城系统演示站</a>
...
<header id="header" class="pngFix">
    <div class="wrapper">
        <h1 id="logo" title="百态商城系统演示站"><a href="${base}"><img
                src="${base}/res/images/common/690ea902fe2708381da2cabff4ee46c8.png" alt="qdmall商城系统演示站" class="pngFix"></a></h1>
...
<div id="footer">
    <div class="wrapper">
        ...
        Copyright 2014-2018 qdmall团队 Inc.All rights reserved.&nbsp;&nbsp;
        ICP证：<br/>
            ...
            if (result) {
                ...
                if (result.goods_all_num > 0) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += "<dd class='goods-thumb'><span class='thumb size40'><i></i><img src='" + data[i]['images'] + "' title='" + data[i]['gname'] + "' style='width:40px;height:40px;' ></span></dd>";
