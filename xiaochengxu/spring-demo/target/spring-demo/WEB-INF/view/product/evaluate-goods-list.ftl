	...
	<div class="body">
		<ul class="list">
		    <li class="li" style="font-weight:bold">
			    <span class="s6">评价心得</span>
			    <span class="s3" style="padding-left: 87px;">顾客满意度</span>
			    <span class="s4">购买信息</span>
			    <span class="s5">评论者</span>
			</li>
			<input type="hidden" name="goodsId" value="${goodsId}"/>
			<#assign goodsEvalutebyGoodsIdTag =newTag("goodsEvalutebyGoodsIdTag")>
			<#assign goodsEvalutes =goodsEvalutebyGoodsIdTag("{'goodsId':'${goodsId}','pageNo':'${pageNo}','toUrl':'${toUrl}','gevalIsAnonymous':'0'}")>
			<#if goodsEvalutes??>
					    ...
					    <dl>
						    ...
						    <dd>
						    	<#list goodsEV.gevalImage?split(",") as gevalImage>  
								    <div class="img">
								    	<a href="${base}/product/detail?id=${goodsId}"><img src="${imgServer}${gevalImage}" alt="" title="" /></a>
								    </div> 
							    </#list>
							</dd><br>
							</#if>
