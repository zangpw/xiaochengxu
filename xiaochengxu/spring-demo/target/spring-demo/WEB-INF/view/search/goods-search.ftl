				      ...
				      <div class="goods-content" nctype_goods="${goods.goodsId}" nctype_store="${goods.storeId}">
						 ...
						 <div class="goods-info" style="top: 230px;">
							<div class="goods-pic-scroll-show">
								...
								<#list goods.goodsImageMore?split(",") as image>
									<#if image!=''>
					                	<li><a href="javascript:void(0);"><img src="${imgServer}${image}_${imageSet.tiny_pic_width}x${imageSet.tiny_pic_height}.${(image?split("."))[image?split(".")?size-1]}" alt="" style="width: 60px;height: 60px;"></a></li>
									</#if>
									<#if image_index==4>
										<#break>
									</#if>
				        ...
				        <div class="sell-stat">
				            <ul>
							  ...
							  <li>
							  <!-- <a class="kefu" href="http://wpa.qq.com/msgrd?v=3&uin=905669187&Site=imjcoder.cn&Menu=yes" target="_blank">
