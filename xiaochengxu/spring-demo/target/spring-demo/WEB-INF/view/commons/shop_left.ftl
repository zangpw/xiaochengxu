								...
								<a href="#">
									<span class="thumb size40">
										...
										<img src="<#if hot.goodsImage??>${imgServer}${hot.goodsImage}<#else>${base}/res/images/common/default_goods_image.gif_small.gif</#if>" 
											title="${hot.goodsName}" style="width: 40px;height: 40px;">
									</span>
								</a>
								<p>
									<span class="thumb size100">
										<i></i>
										<img src="<#if hot.goodsImage??>${imgServer}${hot.goodsImage}<#else>${base}/res/images/common/default_goods_image.gif_small.gif</#if>" style="width: 100px;height: 100px;">
										<big></big>
										<small></small>
									</span>
								</p>
