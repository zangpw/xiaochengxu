...
function big_cart_remove(ids){
			var type=arguments[1];
      			var method = function(){
					   jQuery.post("http://imjcoder.cn/remove_goods_cart.htm",{"ids":ids},function(data){
							if(type=="one_combin"){
								window.location.href="http://imjcoder.cn/wap/goods_cart0.htm";
							}else{
								  if(data.code=="100"){
...
function change_spec(obj){
	...
	var div =jQuery("#standard_"+obj_id);
		...
		jQuery.post("http://imjcoder.cn/goods_cart1_spec.htm",{
			"cart_id":obj_id
			},function(data){
...
function confirm_change_spec(obj){
	...
	jQuery.post("http://imjcoder.cn/goods_cart1_spec_save.htm",{
			"id":id,
			"gsp":gsp
			},function(data){
				if(data.code==100){
			 ...
			 if(id!="" && id!=undefined){
			   var dis = jQuery("#combin_other").css("display");
				   if(dis=="none"){
					   ...
					   jQuery.post("http://imjcoder.cn/combin_carts_detail.htm",
								 {"id":id
									 },function(data){
										 if(data.code==100){
