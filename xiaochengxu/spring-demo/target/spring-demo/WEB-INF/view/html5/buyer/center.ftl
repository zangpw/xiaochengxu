...
<div class="phone_main">
        ...
        <div class="user_nav">
        	<ul>
                ...
                <li class="color_04"><a href="${base}/m/authc/buyer/returnList"><img src="${base}/res/html5/images/user_icon_04.png" /><p>退换货记录</p></a></li>
                ...
                <li class="color_07"><a href="${base}/points/myPointsIndex"><img src="${base}/res/html5/images/user_icon_07.png" /><p>我的积分</p></a></li>
			       ...
			       <#list favoriteGoodsList as favoritegoods>
	            		<li>
		            		<a href="${base}/m/goods/goodsdetail?id=${favoritegoods.favId}">
			            		<img src="${imgServer}${favoritegoods.goods.goodsImage}" style="width:194px;height:auto;"/>
