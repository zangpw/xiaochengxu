...
<title>积分列表 - LmShop B2B2C V3.0 2015版商城系统</title>
...
<div class="order_hd">
    <ul>
      ...
      <li id="order_status_order_nopay">
      	<a href="${base}/points/user/html5/orderList?state=20">待付款</a>
      </li>
      <li id="order_status_order_noship">
      	<a href="${base}/points/user/html5/orderList?state=30">待发货</a>
      </li>
      <li id="order_status_order_notake">
      	<a href="${base}/points/user/html5/orderList?state=40">待收货</a>
      </li>
      <li id="order_status_order_over">
      	<a href="${base}/points/user/html5/orderList?state=50">已收货</a>
      </li>
    </ul>
