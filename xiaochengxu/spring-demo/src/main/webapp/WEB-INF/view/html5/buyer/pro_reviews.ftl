...
<div class="container-fluid tcolor">
	<div class="row stitle" style="height:40px;background: #F8F8F8;">
    <div class="col-sm-3 col-xs-3">
    	<a href="javascript:history.go(-1);" class="f36"><i class="glyphicon glyphicon-menu-left tcolor"></i></a>
    </div>
    <div class="col-sm-6  col-xs-6 text-center">
    	 <span class="f20" style="text-align:center;">商品评价</span>
    </div>
    </div>
</div>
<!--顶部完成 -->
...
<div class="container-fluid" style="border:0px">
	<div class="row">
    	<table class="table-condensed" id="basetables">
         <tr>
	         <td width="28%">
		         <a  href="${base}/m/goods/goodsdetail?id=${orderGoods.goodsId}" target="_blank" title="${orderGoods.goodsName}">
		         	<img style="height:60px;width:60px;" src="${imgServer}${orderGoods.goodsImage}" alt="${orderGoods.goodsName}" class="img-responsive" />
		         </a>
	         </td>
	         <td width="72%">
		         <p>
		         	<a href='${base}/m/goods/goodsdetail?id=${orderGoods.goodsId}' class="f14 color030303">${orderGoods.goodsName}</a>
		         </p>
		         <p class="f16 bao top10">
...
<div class="top10 bgwhite">
 ...
 <div class="clear"></div>
  <p class="btns">
      <p style="margin-left:14px;">
	      ...
	      <span style="margin-top:10px;">匿名评价</span>
      </p>
 ...
 <div class="container-fluid rowtopborder">
 	<div class="row padding10 top10">
    	<div class="col-sm-12">
    		<span class="f16 black">整体评价：</span>
    	 ...
    	 <div>
         	<table>
         		<tr>
         			...
         			<td>
         				<a style="width:60px;height:60px;" class="addImg" href="#none" style="position: relative; z-index: 1;text-decoration:none;">
         					
         					添加图片 <input type="file" onChange="ajaxImageUploads('myBlogImage1')" style="opacity:0; width: 60px;height: 60px;position: relative;background-color: red;margin-top: -80px;" id="myBlogImage1" name="myfiles"  multiple="multiple"/>
            			</a>
         			</td>
         		</tr>
         	</table>
    ...
    <h3 class="f16 black">对店铺信息及服务评分：</h3>
    <div class="reviews-shopinfo" style="height:272px;">
        <dl>
            <dt style="margin-left:5px;">宝贝与描述相符：</dt>
            <dd>
             <div class="commstar-mod">
            ...
            <dt style="margin-left:5px;">卖家的服务态度：</dt>
            <dd>
             <div class="commstar-mod">
            ...
            <dt style="margin-left:5px;">卖家的发货速度：</dt>
            <dd>
	            <div class="commstar-mod">
            ...
            <div class="shop-score" style="width: 100%;">
	            <h5>
	            	商品分数
	            </h5>
	            <ol>
	                <li class="f12 ">商品评分：<b>${evaluateStore.sevalDesccredit}分</b></li>
	                <li class="f12 ">服务评分：<b>${evaluateStore.sevalServicecredit}分</b></li>
	                <li class="f12 ">时效评分：<b>${evaluateStore.sevalDeliverycredit}分</b></li>
	            </ol>
           </div>  
        </dl>
    </div>
        ...
        success:function(data, status){        //服务器响应成功时的处理函数
            if(data.success){
            	...
            	for(var i = 0; i < count; i++){	         
            		...
            		$("#review_img").append("<li class='img_li'style='padding:3px  0px 5px 6px;'><img style='width:60px;height:60px' src='"+photoServcerSrc+"'/><a href='javascript:void(0)' imageSrc='"+photoSrc01+"' id='deletePhoto' onclick='deletePhoto(this)'> 删除</a></li>");
            	}
            }else{
