...
<body class="user_bg">
<div class="user_bar">
	<a class="back" href="${base}/m/goods/goodsdetail?id=${goodsId}&url=${url}&refereurl=${refereurl}&orderState=${orderState}">
...
<div id="wrapper">
	<div id="scroller">	
		...
		<div class="product-consult" id="kfzx">
            <p class="explain">购买之前，如有问题，请向qdmall团队咨询。
                <a href="${base}/m/goods/goodsConsult?goodsId=${goodsId}&url=${url}&refereurl=${refereurl}&orderState=${orderState}" style="color: #3366CC;">我要咨询</a>
            </p>
