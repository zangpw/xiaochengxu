			      ...
			      <#list recommendallgoodslist as recommendgoods>
			          <li>
		                <dl>
		                  ...
		                  <dd class="ncg-pic pngFix"><a href="${base}/product/detail?id=${recommendgoods.goodsId}" target="_blank" class="thumb"><i></i><img src="<#if recommendgoods.goodsImage!=null>${imgServer}${recommendgoods.goodsImage}<#else>${base}/res/images/member/default_image.png</#if>" style="width: 160px;height: 160px;" title="${recommendgoods.goodsName}" alt="${recommendgoods.goodsName}" /></a></dd>
		                  <dd class="ncg-price">
		                                        <em class="price">
		                                        <i>&yen;</i>
