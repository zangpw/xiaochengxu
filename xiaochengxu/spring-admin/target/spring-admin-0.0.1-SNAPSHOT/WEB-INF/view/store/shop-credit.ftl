...
<#if storeVo??>
	...
	<div class="ncs-info clearfix">
	 ...
	 <!--  <div class="shop-im">
	    <h4>联系方式</h4>
	    <p>
	            <a href="http://wpa.qq.com/msgrd?v=3&uin=905669187&Site=imjcoder.cn&Menu=yes" target="_blank"><img src="http://wpa.qq.com/pa?p=2:1234567:51" alt="点击这里给我发消息"></a>
	                </p>
	  </div> -->
	...
	<div class="wrapper">
	  <p><a href="${base}">首页</a>
	                ...
	                | <a  href="#?act=article&amp;article_id=22">关于我们</a>
	                            </p>Copyright 2014-2018 qdmall团队 Inc.All rights reserved.&nbsp;&nbsp;ICP证：<br/>
