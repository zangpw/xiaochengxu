			      ...
			      <#list recommendgoodslist as recommendgoods>
			          <li>
		                <dl>
		                  ...
		                  <dd class="ncg-pic pngFix"><a href="${base}/qdmall-front/product/detail?id=${recommendgoods.goodsId}" target="_blank" class="thumb"><i></i><img src="${imgServer}${recommendgoods.goodsImage}" style="width: 160px;height: 160px;" title="${recommendgoods.goodsName}" alt="${recommendgoods.goodsName}" /></a></dd>
			      ...
			      <#list newProductlist as newGoods>
			          <li>
		                <dl>
		                  ...
		                  <dd class="ncg-pic pngFix"><a href="${base}/qdmall-front/product/detail?id=${newGoods.goodsId}" target="_blank" class="thumb"><i></i><img src="${imgServer}${newGoods.goodsImage}" style="width: 160px;height: 160px;" title="${newGoods.goodsName}" alt="${newGoods.goodsName}" /></a></dd>
		                  <dd class="ncg-price"><em class="price"><i>&yen;</i>
