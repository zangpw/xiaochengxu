...
<div class="phone_main">
  ...
  <div class="logo_line">
	  <img src="${base}/res/html5/images/logo.png" width="170px" height="33px"/> 
	  	<@shiro.guest>
  ...
  <div class="nav">
    <ul>
      ...
      <li><a href="${base}/m/authc/buyer/center"><img src="${base}/res/html5/images/nav_user.png" />
        ...
        <li>
	        <a href="${base}/points/html5PointsIndex">
	        	<img src="${base}/res/html5/images/nav_03.png" />
	        	<p>积分兑换</p>
	        </a>
        </li>
	        ...
	        <ul class="piclist">
	            <#if recommendGoodslist??>
                	<#list recommendGoodslist as recommendGoods>
	                         <li>
		                         <a href="${base}/m/goods/goodsdetail?id=${recommendGoods.goods.goodsId}&url=referer">
		...
		<#list json as item>
		    <div class="phone_floor">
				<div class="phone_activity">
			      	...
			      	<#if (goods_index<3)>
			        	<li>
			        		<a href="${base}/m/goods/goodsdetail?id=${goods.goodsId}&url=referer">
			        			<img src="${imgServer}${goods.goodsImage}" style="width:194px;height:194px;"/>
					          	<p class="price">
