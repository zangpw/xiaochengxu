...
<body class="index_bg">
<div class="phone_hd"><a class="back" href="${base}/m/index/index"><img src="${base}/res/html5/images/back.png" width="25" height="25" /></a>商品分类<a class="menu home" href="${base}/m/index/index"><img src="${base}/res/html5/images/home.png" width="25" height="25" /></a></div>
<div class="category">
