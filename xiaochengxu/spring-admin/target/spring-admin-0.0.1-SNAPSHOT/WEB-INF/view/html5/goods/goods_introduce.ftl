...
<div class="phone_main">
  <!--0元试用详细页-->
  <#if 1=='${isShow}'>
	<div class="phone_hd"><a class="back" href="${base}/m/goods/goodsdetail?id=${goodsId}&url=${url}&refereurl=${refereurl}&orderState=${orderState}"><img src="${base}/res/html5/images/back.png" width="25" height="25" /></a>商品详细<a class="menu home" href="${base}/m/index/index"><img src="${base}/res/html5/images/home.png" width="25" height="25" /></a></div>
  </#if>
