   ...
   jQuery(window).scroll(function(){								  
	 if (jQuery(document).scrollTop() >= jQuery(document).height() - jQuery(window).height()&&ret==1) {
		...
		jQuery.ajax({type:'POST',
	              url:'http://imjcoder.cn/wap/buyer/group_life_return.htm',
...
<div class="layer">
    ...
    <div class="layer_show" id="show" mark="hide" style="display:none">
    	<ul>
        	<li><a href="http://imjcoder.cn/wap/index.htm"><img src="${base}/res/html5/images/layer_01.png" width="20" height="20" /><p>首页</p></a></li>
            <li><a href="http://imjcoder.cn/wap/buyer/order_list.htm"><img src="${base}/res/html5/images/layer_02.png" width="20" height="20" /><p>订单</p></a></li>
            <li><a href="http://imjcoder.cn/wap/goods_cart1.htm"><img src="${base}/res/html5/images/layer_03.png" width="20" height="20" /><p>购物车</p></a></li>
            <li><a href="http://imjcoder.cn/wap/buyer/center.htm"><img src="${base}/res/html5/images/layer_04.png" width="20" height="20" /><p>用户中心</p></a></li>
        </ul>
